export default function MovieCard({movieDetails}){
    ...
    return (
        ...
        <div className="embla__slide grow-0 shrink-0 md:basis-[25%] sm:basis-[30%] basis-[30%] min-w-0 pl-(--slide-spacing) ">
            <img src={`${IMG_BASE}${movieDetails.poster_path}`} alt="poster" className="
            border-4 border-primary-dark-900 w-62.5" />
            <div className="info font-manrope font-bold" >
